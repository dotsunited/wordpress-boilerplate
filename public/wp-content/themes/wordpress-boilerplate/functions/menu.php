...
function wordpress_boilerplate_find_menu_root($location, $selector, $directParent = false) {
    ...
    $menuItems = wp_get_nav_menu_items($menu->term_id, ['order' => 'DESC', 'update_post_term_cache' => false]);
...
function wordpress_boilerplate_submenu_limit($items, $args) {
    ...
    $ids       = wp_filter_object_list($items, ['title' => $args->submenu], 'and', 'ID');
